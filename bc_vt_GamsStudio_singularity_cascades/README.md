...
An interactive app designed for OSC OnDemand that launches the GAMS app hosted on a Rocker Shiny Server
...
[Rocker/Shiny Server]: https://github.com/rocker-org/shiny
